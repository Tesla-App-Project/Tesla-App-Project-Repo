...
<header>
    ...
    <section class="cacher-tablet">
        <section class="horizontal-controle">
            ...
            <img class="cadenasPos hover-img"  src="assets/images/cadenaslock.png" alt="cadenasLock" onclick="sendRequest('http://localhost:8080/index.php?url=DevTest/control_doors')">
