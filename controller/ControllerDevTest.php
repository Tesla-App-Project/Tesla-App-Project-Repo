...
final class ControllerDevTest
{
    ...
    public function wake_upAction()
    {
        ...
        View::show('helloworld/HelloworldView', array('helloworld' => var_dump($O_apimodel->tempInside())));
        //View::show('helloworld/HelloworldView', array('helloworld' => var_dump($O_apimodel->batteryState())));
